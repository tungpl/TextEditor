...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		LinkedList<String> retList = new LinkedList<String>();   // words to return
		 
		if(word==null||word.isEmpty()) return retList;
		// insert first node
		queue.add(word);
		visited.add(word);
		...
		while(retList.size()<numSuggestions && queue.size() > 0){
			...
			List<String> neighbor = this.distanceOne(curr, true);
